...
export interface UseInputNumberParams {
  ...
  /** The consumer's native blur handler, appended after the internal rollback/clamp bookkeeping. */
  onBlur: FocusEventHandler<HTMLInputElement> | undefined;
  /** The consumer's native key handler, appended after the internal Arrow Up/Down stepping. */
...
export interface UseInputNumberResult {
  ...
  /** Arrow Up/Down stepping (preventDefault), then the consumer's handler. */

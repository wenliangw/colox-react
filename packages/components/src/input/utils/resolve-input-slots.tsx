...
interface ResolveInputSlotsParams {
  ...
  readOnly?: boolean;
  /**
   * Whether the password visibility toggle is active
   * (`allowTogglePassword` and type `password`).
   */
...
export interface ResolvedInputSlots {
  /**
   * The leading slot content — the automatic search icon fills in for
   * a `type="search"` input without an explicit `leading`.
   */
